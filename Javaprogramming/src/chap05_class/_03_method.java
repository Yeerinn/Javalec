...
public class _03_method {
	...
	public static void main(String[] args) {
		...
		//강제 형변환을 통해서 변수의 타입과 맞춰주면 자른 타입의 변수로도 받을 수 있다.
		...
		//void형태는 반환타입이 없기 때문에 메소드내에서 미리 선언해놓은 전역변수나 static변수에 결과 값을 담아서 사용한다.
		add(5, 6, 7);
	...
	//곱하기 메소드 만들기(메소드명: multiple, 반환타입은 long(매개변수 2개), void(매개변수 3개))
