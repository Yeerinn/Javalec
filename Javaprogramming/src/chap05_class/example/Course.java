...
public class Course {
	...
	public Course(int cNo) {
		//this 객체 : 현재 속해있는 클래스를 지칠
		//매개변수로 받아온 cNo과 멤버변수 cNo을 확식하게 구분하기 위해서 this 사용
		this.cNo = cNo;
	}
	//매개변수가 두 개인 생성자
	...
	public Course(int cNo, String cName, int cScore) {
		...
		//현재 생성자에서는 따로 cNo, cName에 대한 초기화 작업 필요없어진다.
		this(cNo, cName); //Course의 생성자 호출
